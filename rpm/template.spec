...
Name:           ros-kilted-robstride-examples
Version:        0.2.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS robstride_examples package
...
Requires:       ros-kilted-ros2-socketcan
...
%description
Ready-to-use Xacro profiles, ros2_control configuration, and launch examples for
RobStride actuators.
